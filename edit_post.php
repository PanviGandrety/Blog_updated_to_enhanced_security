...
<div class="container mt-4" style="max-width:800px;">
  ...
  <form method="post">
    ...
    <div class="mb-2"><input name="title" class="form-control" value="<?php echo e($title); ?>"></div>
    <div class="mb-2"><textarea name="content" class="form-control" rows="6"><?php echo e($content); ?></textarea></div>
